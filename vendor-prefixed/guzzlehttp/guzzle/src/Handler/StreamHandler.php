...
namespace pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Handler;

use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Exception\ConnectException;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Exception\RequestException;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Promise\FulfilledPromise;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Promise\PromiseInterface;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Psr7;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\TransferStats;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Utils;
use pxlrbt\CF7WeClapp\Vendor\Psr\Http\Message\RequestInterface;
use pxlrbt\CF7WeClapp\Vendor\Psr\Http\Message\ResponseInterface;
use pxlrbt\CF7WeClapp\Vendor\Psr\Http\Message\StreamInterface;
/**
...
class StreamHandler
{
    ...
    public function __invoke(RequestInterface $request, array $options)
    {
        ...
        try {
            ...
            return \pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Promise\rejection_for($e);
        }
    }
    ...
    private function createResponse(RequestInterface $request, array $options, $stream, $startTime)
    {
        ...
        $headers = \pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\headers_from_lines($hdrs);
        ...
        if (isset($options['on_headers'])) {
            try {
                ...
                return \pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Promise\rejection_for($ex);
            }
        }
    ...
    private function checkDecode(array $options, array $headers, $stream)
    {
        ...
        if (!empty($options['decode_content'])) {
            $normalizedKeys = \pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\normalize_header_keys($headers);
    ...
    private function add_proxy(RequestInterface $request, &$options, $value, &$params)
    {
        if (!\is_array($value)) {
            ...
            if (isset($value[$scheme])) {
                if (!isset($value['no']) || !\pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\is_host_in_noproxy($request->getUri()->getHost(), $value['no'])) {
    ...
    private function add_verify(RequestInterface $request, &$options, $value, &$params)
    {
        if ($value === \true) {
            ...
            if (\PHP_VERSION_ID < 50600) {
                $options['ssl']['cafile'] = \pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\default_ca_bundle();
            }
    ...
    private function add_debug(RequestInterface $request, &$options, $value, &$params)
    {
        ...
        $value = \pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\debug_resource($value);
