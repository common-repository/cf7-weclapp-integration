...
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Cookie\CookieJar;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Exception\GuzzleException;
use pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\Promise;
...
use pxlrbt\CF7WeClapp\Vendor\Psr\Http\Message\UriInterface;
/**
...
class Client implements ClientInterface
{
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        if (isset($options['json'])) {
            $options['body'] = \pxlrbt\CF7WeClapp\Vendor\GuzzleHttp\json_encode($options['json']);
            unset($options['json']);
            // Ensure that we don't have the header in different case and set the new value.
            $options['_conditional'] = Psr7\_caseless_remove(['Content-Type'], $options['_conditional']);
