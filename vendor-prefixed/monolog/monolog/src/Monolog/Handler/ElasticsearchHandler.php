 ...
 */
namespace pxlrbt\CF7WeClapp\Vendor\Monolog\Handler;

use pxlrbt\CF7WeClapp\Vendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use pxlrbt\CF7WeClapp\Vendor\Monolog\Logger;
use pxlrbt\CF7WeClapp\Vendor\Monolog\Formatter\FormatterInterface;
use pxlrbt\CF7WeClapp\Vendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use pxlrbt\CF7WeClapp\Vendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use pxlrbt\CF7WeClapp\Vendor\Elasticsearch\Client;
use pxlrbt\CF7WeClapp\Vendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use pxlrbt\CF7WeClapp\Vendor\Elastic\Elasticsearch\Client as Client8;
/**
