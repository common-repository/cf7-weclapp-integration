...
use pxlrbt\CF7WeClapp\Vendor\Monolog\Formatter\LineFormatter;
use pxlrbt\CF7WeClapp\Vendor\Monolog\Formatter\FormatterInterface;
use pxlrbt\CF7WeClapp\Vendor\Monolog\Logger;
use pxlrbt\CF7WeClapp\Vendor\Monolog\Utils;
use pxlrbt\CF7WeClapp\Vendor\PhpConsole\Connector;
use pxlrbt\CF7WeClapp\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use pxlrbt\CF7WeClapp\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('pxlrbt\\CF7WeClapp\\Vendor\\PhpConsole\\Connector')) {
