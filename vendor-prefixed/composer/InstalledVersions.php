 ...
 */
namespace pxlrbt\CF7WeClapp\Vendor\Composer;

use pxlrbt\CF7WeClapp\Vendor\Composer\Autoload\ClassLoader;
use pxlrbt\CF7WeClapp\Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('pxlrbt\\CF7WeClapp\\Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
