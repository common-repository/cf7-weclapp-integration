...
namespace pxlrbt\CF7WeClapp\Vendor\Psr\Log\Test;

use pxlrbt\CF7WeClapp\Vendor\Psr\Log\LoggerInterface;
use pxlrbt\CF7WeClapp\Vendor\Psr\Log\LogLevel;
use pxlrbt\CF7WeClapp\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('pxlrbt\\CF7WeClapp\\Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('pxlrbt\\CF7WeClapp\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('pxlrbt\\CF7WeClapp\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
